...
Note:
- The **.selenium** file extension contains a list of URLs that are exported from HTML to PDF, then indexed
- The **.crawler** file extension contains a list of website URLs or sitemaps that are crawled. Any URL found in a page is also indexed. It is limited to the original URL domain. 
